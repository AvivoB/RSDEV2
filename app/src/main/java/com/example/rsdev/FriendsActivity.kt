                    ...
                    for (friend_id in friendsArray) {
                        ...
                        friendRef.get().addOnSuccessListener { friend ->
                            ...
                            delete_friend.setOnClickListener {
                                ...
                                // users.document(friend.id)
                                // users.document(friend.id). friendRef.addSnapshotListener() whereArrayContains("favoriteNames", friendRef.id)
                                // friendRef. update("friends", FieldValue.arrayRemove(friendRef.id))
                            }
                        }
                    }
                }
